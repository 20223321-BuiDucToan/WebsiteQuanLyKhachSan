                ...
                <div class="card-body p-4">
                    ...
                    @if(!$coTheCapNhatDichVu)
                        <div class="alert alert-warning">
                            Đã hoàn thành hoặc hủy, không thể cập nhật dịch vụ nữa. Nếu cần thay đổi, vui lòng liên hệ bộ phận hỗ trợ để được trợ giúp.
                        </div>
                    @endif

                    @if($danhSachDichVuHoatDong->isEmpty())
                        <div class="alert alert-light border">
                           Chưa có dịch vụ nào đang hoạt động. Vui lòng thêm dịch vụ vào hệ thống trước khi ghi nhận sử dụng dịch vụ cho đơn này.
                        </div>
                    @endif
