...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="section-title mb-1">Quản lý người dùng</h2>
            <p class="section-subtitle">Quản lý tài khoản nội bộ hệ thống</p>
        </div>
            ...
            <form method="GET" action="{{ route('nguoi-dung.index') }}">
                <div class="row g-3">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="tu_khoa" class="form-control rounded-4"
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="vai_tro" class="form-select rounded-4">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="trang_thai" class="form-select rounded-4">
                            <option value="">-- Tất cả --</option>
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <button class="btn btn-primary rounded-4 w-100">Lọc</button>
                    </div>
                </div>
            </form>
        </div>
