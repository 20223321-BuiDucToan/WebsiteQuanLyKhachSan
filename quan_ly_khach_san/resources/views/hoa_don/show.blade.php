                        ...
                        <form method="POST" action="{{ route('hoa-don.cap-nhat-trang-thai', $hoaDon) }}">
                            ...
                            <div class="d-flex gap-2">
                                <select name="trang_thai" class="form-select">
                                    ...
                                    <option value="da_huy" @selected($hoaDon->trang_thai === 'da_huy')>Đã hủy</option>
                                </select>
            ...
            <div class="premium-card">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('thanh-toan.store') }}" method="POST" class="row g-3">
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-gradient w-100" @disabled($hoaDon->trang_thai === 'da_huy')>Ghi nhận thanh toán</button>
                        </div>
                    </form>
                </div>
            </div>
